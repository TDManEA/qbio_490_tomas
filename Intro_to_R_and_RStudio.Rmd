...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/tomasmanea/Desktop/QBIO490/r_practice")) 
```
...
age <- 21
birthday <- "11/30/2001"
three_fav_colors <- "Blue, green, yellow"
##string_var, numeric, string, string
```
...
while (mean_val <= 10) {
  print(mean_val)
  x = x + 1
  my_list <- c(1, 10, x) ##updating list with new x value
  mean_val <- mean(my_list)
